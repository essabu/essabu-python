"""API client for managing supplier resources."""
...
class SupplierApi(BaseApi):
    """API client for managing supplier resources. Base path: /api/accounting/suppliers"""
    BASE_PATH = "/api/accounting/suppliers"
    def __init__(self, http: HttpClient) -> None:
        super().__init__(http)
    def create(self, request: dict[str, Any]) -> dict[str, Any]:
        return self._http.post(self.BASE_PATH, request)
    def get(self, supplier_id: str) -> dict[str, Any]:
        return self._http.get(f"{self.BASE_PATH}/{supplier_id}")
    ...
    def update(self, supplier_id: str, request: dict[str, Any]) -> dict[str, Any]:
        return self._http.put(f"{self.BASE_PATH}/{supplier_id}", request)
    def delete(self, supplier_id: str) -> None:
        self._http.delete(f"{self.BASE_PATH}/{supplier_id}")
